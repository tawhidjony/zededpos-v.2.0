            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title "><!-- start -->
                        <form action="{{url('/sale-report')}}" method="get" class="inline d-flex
                ...
                <div class="card-body">
                    <table id="example" class="table table-bordered ">
                        ...
                        <tbody>
                             ...
                             @foreach($sale_report as $reportSale)
                                <tr>
                                    <td>{{$reportSale->total}}</td>
                                    <td>{{$reportSale->discount}}</td>
                                    <td>{{$reportSale->grand_total}}</td>
                                    <td>{{$reportSale->return_amount}}</td>
                                    <td>{{$reportSale->pay_amount}}</td>
                                    <td>{{ date('d-M-Y',strtotime($reportSale->updated_at))}}</td>
