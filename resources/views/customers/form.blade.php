...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <img id="image" src="{{URL::to($customer->photo)}}" style="width: 100px; height: 100px; margin-top: 5px;">
        @else
            <img id="image" src="{{asset('defaultimg/imguploadicon.png')}}" style="width: 100px; height: 100px; margin-top: 5px;">
        @endif
    </div>
</div>
<!-- End -->
