    ...
    <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <!--start box Header-->
                    <div class="card-body">
                        <h3 >All Tag Sub Category <a href="{{route('categories.index')}}" class="btn btn-info
                    ...
                    <div class="card-body">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            @foreach($tag_sub_category as $key=> $row)
                            <tr>
                                <td>{{$key + 1 }}</td>
                                <td>{{$row->name}}</td>
                                <td>
                                    <div class="btn-group m-1">
                                        ...
                                        {{--</a>--}}
                                        <form user="deleteForm" method="POST" action="{{route('chilTag.destroy',$row->id)}}">
                                            @csrf
                                            @method('DELETE')
