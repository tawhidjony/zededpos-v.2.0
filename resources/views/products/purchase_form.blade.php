    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <span class="input-group-text pb-0 pt-0">
                   <a href="#" data-toggle="modal" data-target="#CategoryModal" ><i class="fa fa-plus"></i> </a>
                </span>
            </div>
    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <span class="input-group-text pb-0 pt-0">
                   <a href="#" data-toggle="modal" data-target="#SubCategoryModal"><i class="fa fa-plus"></i> </a>
                </span>
            </div>
    ...
    <!--End-->
     ...
     <div class="col-sm-6">
            <div class="input-group mb-3">
                ...
                <select id="inputState" type="text" class="form-control" name="tag_sub_category_id" >
                    <option value >Select Tag Sub Category</option>
                    @foreach($tag_sub_categories as $key => $subCategories)
                        <option value="{{$subCategories->id}}"
                                @if($product->sub_category_id && $product->sub_category_id == $subCategories->id) selected @endif >{{$subCategories->name}}</option>
                    @endforeach
                </select>
                <div class="input-group-append">
                    <span class="input-group-text pb-0 pt-0">
                       <a href="#" data-toggle="modal" data-target="#TagSubCategoryModal"><i class="fa fa-plus"></i> </a>
                    </span>
                </div>
    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <span class="input-group-text pb-0 pt-0">
                   <a href="#" data-toggle="modal" data-target="#BrandModal"><i class="fa fa-plus"></i> </a>
                </span>
            </div>
    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <span class="input-group-text pb-0 pt-0">
                   <a href="#" data-toggle="modal" data-target="#ProductUnit"><i class="fa fa-plus"></i> </a>
                </span>
            </div>
        </div>
    </div>
